...
public class ProductResponses {
    ...
    public ProductResponses(Boolean responseBoolean, List<Producto> products) {
        this.responseBoolean = responseBoolean;
    ...
    public Map<String, Object> responseProductFilters200() {
        ...
        response.put("productos", productList);
        response.put("filtros-aplicados", responseBoolean.toString());
